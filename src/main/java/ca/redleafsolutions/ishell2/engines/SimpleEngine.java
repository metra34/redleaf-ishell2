...
//	}
	...
	@Override
	public IShellObject execute (IShellRequest request) throws ExtensionNotFound,
			ca.redleafsolutions.ishell2.IShellException.InvocationTargetException {
	...
	@Override
	public IShellObject execute (IShellRequestSingle request) throws ExtensionNotFound,
			ca.redleafsolutions.ishell2.IShellException.InvocationTargetException {
		Object root;
	...
	@Override
	public void extend (JSONItem obj) throws ClassNotFoundException, NoSuchMethodException, SecurityException,
...
//				extendValidator.validate (item);
	...
	private IShellObject _execute (Object res, IShellRequestSingle request, int index) throws IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, ResourceNotFound, BadParameters,
			IllegalFunctionOverload {
...
//			}
				...
				for (String pname: pnames.value ()) {
					...
					if (pvalue != null) {
						...
						try {
							...
							throw new IllegalArgumentException ("argument '" + pname
									+ "' type mismatch. Expected File but get " + ptype);
						}
						++i;
					} else {
						match = false;
	...
	private IShellObject callMethodNoParams (int index, IShellRequestSingle request, Map<Integer, Method> matchMethods,
			Object res, Object newres) throws IllegalAccessException, IllegalArgumentException,
			InvocationTargetException, ResourceNotFound, BadParameters, IllegalFunctionOverload {
				...
				try {
					...
					try {
						...
						try {
							...
							throw new IllegalArgumentException ("Argument type mismatch. Expected Date but got "
									+ pvalue);
						}
					}
				}
	...
	private void assignField (Field field, Object value, Object res) throws IllegalArgumentException,
